...
type ColorPickerTriggerProps = React.ComponentProps<typeof Popover.Trigger>
...
type ColorPickerContentProps = React.ComponentProps<typeof Popover.Content>
    ...
    if (context.inline) {
        ...
        return (
            <ContentPrimitive
                ...
                {...popoverContentProps}
                className={cn("flex w-72 h-[340px] flex-col gap-4 p-4", className)}
            >
                {children}
            </ContentPrimitive>
        );
    ...
    return (
        ...
        >
            <SliderPrimitive.Track
                className="relative h-2 w-full grow overflow-hidden rounded-full bg-[linear-gradient(to_right,#ff0000_0%,#ffff00_16.66%,#00ff00_33.33%,#00ffff_50%,#0000ff_66.66%,#ff00ff_83.33%,#ff0000_100%)]">
